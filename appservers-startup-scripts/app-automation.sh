...
aws s3 cp s3://prod-proxy-app-db-config-omari/dbinfo.inc /var/www/inc

#11. Create a new file in the ``html`` directory named OmariMailingApp.php, 
# UPDATE S3 BUCKET/OBJECT NAME
aws s3 cp s3://prod-proxy-app-db-config-omari/OmariMailingApp.php /var/www/html
